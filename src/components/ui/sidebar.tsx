	...
	return (
		...
		>
			...
			>
				<div
					data-sidebar="sidebar"
					className="bg-sidebar px-4 pt-8 group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
				>
					{children}
				</div>
			</div>
...
function SidebarSeparator({
	...
	return (
		<Separator
			...
			className={cn("bg-sidebar-border mx-4 w-auto", className)}
			{...props}
		/>
	);
}
